...
// require_once CUSTOM_FORM_PLUGIN_PATH . 'admin-menu.php';
...
// require_once CUSTOM_FORM_PLUGIN_PATH . 'shortcode.php';
...
function add_custom_form_page() {
    add_menu_page('Custom Form', 'Custom Form', 'manage_options', 'custom-form-plugin-form', 'display_custom_form_page');
}
...
//             $custom_search_results .= '<h2>Search Results</h2>';
//             $custom_search_results .= '<table>';
//             $custom_search_results .= '<tr><th>ID</th><th>Serial No</th><th>Name</th></tr>';
//             foreach ($results as $row) {
//                 $custom_search_results .= '<tr>';
//                 $custom_search_results .= '<td>' . esc_html($row['id']) . '</td>';
//                 $custom_search_results .= '<td>' . esc_html($row['serial_no']) . '</td>';
...
//             echo '</div>';
//         } else {
//             echo '<p>No results found for the given serial number.</p>';
//         }
//     }
// }
// add_action('template_redirect', 'handle_custom_form_search');
